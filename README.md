...
Welcome to the Docker Chennai Meetup Community repo! This repo aims to centralize content (Meetup presentations, slides, recorded videos, etc) curated by the community members for the Docker Chennai Meetup Community. The main objective is to help members of the Docker Bangalore Meetup community who share similar interests to learn from & collaborate with each other during events. 


 ![My Image](https://github.com/collabnix/dockerchennai/blob/master/images/image1.png)

 
# Upcoming Meetup | Conference

[21-September 2019 - #8 Docker Chennai Meetup #8 : Docker, DevOps & IoT](https://events.docker.com/events/details/docker-chennai-presents-docker-chennai-meetup-8-docker-devops-iot/#/)
